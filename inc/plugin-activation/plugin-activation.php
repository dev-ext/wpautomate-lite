...
function wpautomate_plugin_activation() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/inc/plugins/rev_slider.zip',
			'required'           => true
		),
		...
		array(
			...
			'slug'        => 'ultimate-vc',
			'source'             => get_stylesheet_directory() . '/inc/plugins/ultimate_vc.zip',
			'required'           => true
		),

		array(
			'name'        => 'Theme VC addons',
			'slug'        => 'theme-vc-addons',
			'source'             => get_stylesheet_directory() . '/inc/plugins/theme-vc-addons.zip',
			'required'           => true
		),
